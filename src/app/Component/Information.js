  ...
  return (
    <div className="bg-black py-10">
      <div className="flex flex-col justify-center items-center bg-black text-white max-w-[90%] lg:max-w-[80%] mx-auto space-y-10 overflow-hidden">
        <div className={`flex flex-col-reverse lg:flex-row ${isRight ? 'lg:flex-row-reverse' : ''} py-5 px-5 lg:px-10`}>
          
          {/* Image Section */}
          <motion.div
            style={{ scale, opacity }}
            className={`flex-1 flex justify-center lg:px-[50px] ${isRight ? 'lg:justify-start' : 'lg:justify-end'}`}>
            <Image
              src={image}
